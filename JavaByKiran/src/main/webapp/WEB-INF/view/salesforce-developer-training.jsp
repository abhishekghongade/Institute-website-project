      ...
      <div class="row">
        ...
        <div class="col-md-6">
          <div class="detail-box">
            ...
            Salesforce Developer Training is designed to prepare individuals to develop and customize applications on the Salesforce platform, one of the leading customer relationship management (CRM) platforms in the world. Below is an overview of what you might expect to learn in a Salesforce Developer Training course:
            <p>
            <h4>
              Key Highlights
            </h4>
             <li>In-depth understanding of the Salesforce platform</li>
             <li>Practical hands-on exercises and real-life projects</li>
             <li>Proficiency in the Apex programming language </li>
