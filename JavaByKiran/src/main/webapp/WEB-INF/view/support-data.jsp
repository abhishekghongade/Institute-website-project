<!DOCTYPE html>
<%@page import="com.jbk.entity.UserDetails"%>
<%@page import="java.util.List"%>
<%@page import="org.apache.jasper.tagplugins.jstl.core.ForEach"%>
<%@page import="com.jbk.entity.TicketData"%>
<html>
...
<body>
  ...
  <%
    List<TicketData> list=  (List<TicketData>)request.getAttribute("list");
  %>
  <%for (TicketData ticketData : list) { 
   %>
   
  <tr>
    <td><%out.println(ticketData.getName());%></td>
    <td><%out.println(ticketData.getEmail()); %></td>
    <td><%out.println(ticketData.getBatch()); %></td>
    <td><%out.println(ticketData.getSubject()); %></td>
    <td><%out.println(ticketData.getMsg()); %></td>
  </tr>
