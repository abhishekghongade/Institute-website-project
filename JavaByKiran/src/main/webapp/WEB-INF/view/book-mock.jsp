  ...
  <section class="about_section layout_padding long_section">
    <div class="container">
      <div class="row">
        <div class="col-md-6">
          <div class="img-box">
            <img src="images/mock-interview.png" alt="">
          </div>
        </div>
        <div class="col-md-6">
          <div class="detail-box">
            ...
            <p>
    You Can Give Mock Interview On any Active Course that you are learning For your practice and it will help you to grow your knowledge about that respected Course and give you confidence about company interview. So, do Register on the below link to schedule your Mock Interview.
            </p>
            <a href="/schedule-mock">
              Schedule Mock
            </a>
          </div>
        </div>
