...
<body>
  ...
  <%
    List<UserDetails> list=  (List<UserDetails>)request.getAttribute("userdata");
  %>
  <%for (UserDetails userData : list) { 
   %>
   
  <tr>
    <td><%out.println(userData.getName());%></td>
    <td><%out.println(userData.getEmail()); %></td>
    <td><%out.println(userData.getUsername()); %></td>
    <td><%out.println(userData.getPassword()); %></td>
  </tr>
