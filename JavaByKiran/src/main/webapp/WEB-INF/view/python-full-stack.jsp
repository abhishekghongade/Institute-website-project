      ...
      <div class="row">
        ...
        <div class="col-md-6">
          <div class="detail-box">
            ...
            Python full-stack courses are designed to provide you with a well-rounded skill set that enables you to create end-to-end web applications. The specific content and tools covered may vary depending on the course and the instructor, so it's a good idea to review the course syllabus to ensure it aligns with your learning goals.
            <p>
            <h4>
              Key Highlights
            </h4>
             <li>Comprehensive training on Python Full Stack</li>
             <li>Practical hands-on exercises and real-life projects</li>
             <li>Certification or Portfolio Building</li>
