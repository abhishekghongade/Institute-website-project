      ...
      <div class="row">
        ...
        <div class="col-md-6">
          <div class="detail-box">
            ...
            Angular Developer Training is a comprehensive program designed to teach individuals how to develop web applications using the Angular framework. Angular is a popular and powerful front-end development framework maintained by Google. Here's an overview of what you might expect to learn in an Angular Developer Training course:
            <p>
            <h4>
              Key Highlights
            </h4>
             <li>Build real-world web applications using Angular</li>
             <li>Work on industry-relevant projects and assignments</li>
             <li>Understand Angular's architecture and best practices </li>
             <li>Master the key concepts of Angular framework</li>
             </p>
             <h4>
               Rs. 24999.00
            </h4>
