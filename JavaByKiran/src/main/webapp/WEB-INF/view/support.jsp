  ...
  <section class="about_section layout_padding long_section">
    <div class="container">
      <div class="row">
        <div class="col-md-6">
          <div class="img-box">
            <img src="images/problem-solving.png" alt="">
          </div>
        </div>
        <div class="col-md-6">
          <div class="detail-box">
            ...
            <p>
             If you encounter any challenges or have questions, please don't hesitate to contact us. Our team is here to provide you with the assistance you need. Feel free to ask, and we'll be more than happy to help. By Clicking on Raise Ticket you can tell your Problem by filling form. Our team solve your problem within 24hrs. 
            </p>
