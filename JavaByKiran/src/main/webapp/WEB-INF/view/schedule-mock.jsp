        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <div class="d-flex mx-auto flex-column flex-lg-row align-items-center">
            ...
            <div class="quote_btn-container">
              <span>
                Hello <%out.println(request.getAttribute("puname2")); %>
              </span>
          </div>
          </div>
          <a href="/logout">
...
<div class="formbold-main-wrapper">
  ...
  <div class="formbold-form-wrapper">
    <form action="schedule-mock" method="POST">
      ...
      <div class="formbold-mb-5">
       ...
       <div class="formbold-mb-5">
        <label for="email" class="formbold-form-label"  > Time Slot </label>
        <select  class="formbold-form-input" required name="time">
      ...
      <div>
        <button class="formbold-btn">Schedule Mock</button>
      </div>
      <div class="formbold-mb-5">
       ...
       <%
        if(request.getAttribute("scheduled")!=null){
   		...
   		out.println(request.getAttribute("scheduled"));
