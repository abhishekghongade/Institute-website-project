...
<body>
  ...
  <%
    List<BuyerDetails> list=  (List<BuyerDetails>)request.getAttribute("buyerdata");
  %>
  <%for (BuyerDetails buyerData : list) { 
   %>
   
  <tr>
    <td><%out.println(buyerData.getBuyerName());%></td>
    <td><%out.println(buyerData.getBuyerEmail()); %></td>
    <td><%out.println(buyerData.getBuyerPhone()); %></td>
    <td><%out.println(buyerData.getCourseName()); %></td>
    <td><%out.println(buyerData.getCoursePrice()); %></td>
  </tr>
