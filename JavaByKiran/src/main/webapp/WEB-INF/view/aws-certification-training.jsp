      ...
      <div class="row">
        ...
        <div class="col-md-6">
          <div class="detail-box">
            ...
            These courses are designed to prepare you for AWS certification exams, such as AWS Certified Solutions Architect, AWS Certified Developer, AWS Certified SysOps Administrator, and more.
            They cover a broad range of AWS services and best practices for designing, building, and maintaining applications on AWS.            </p>
            <p>
            <h4>
              Key Highlights
            </h4>
             <li>Hands-on training with real-world AWS projects</li>
