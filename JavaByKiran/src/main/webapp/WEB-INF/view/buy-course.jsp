...
<div class="formbold-main-wrapper">
  ...
  <div class="formbold-form-wrapper">
    <form method="POST">
      ...
      <div class="formbold-mb-5">
        <label for="email" class="formbold-form-label"  > Course </label>
        <select  class="formbold-form-input" required name="courseName">
               <option selected >Select Your Course</option>
                   <option value="JAVA FULL STACK TRAINING" >JAVA FULL STACK TRAINING</option>
                     <option value="AWS CERTIFICATION TRAINING">AWS CERTIFICATION TRAINING</option>
                    <option value="SELENUIM TESTING TRAINING">SELENUIM TESTING TRAINING</option>
             		<option value="PYTHON FULL STACK TRAINING">PYTHON FULL STACK TRAINING</option>
             		<option value="SALESFORCE DEVELOPER TRAINING">SALESFORCE DEVELOPER TRAINING</option>
             		<option value="ANGULAR DEVELOPER TRAINING">ANGULAR DEVELOPER TRAINING</option>
             </select>
      </div>  
      <div>
        <button formaction="/buy-course" class="formbold-btn">BUY</button>
      </div>
