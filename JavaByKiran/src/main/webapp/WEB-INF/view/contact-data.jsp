<!DOCTYPE html>
<%@page import="com.jbk.entity.ContactDeatils"%>
...
<body>
  ...
  <%
    List<ContactDeatils> list=  (List<ContactDeatils>)request.getAttribute("contactdata");
  %>
  <%for (ContactDeatils contactData : list) { 
   %>
   
  <tr>
    <td><%out.println(contactData.getName());%></td>
    <td><%out.println(contactData.getEmail()); %></td>
    <td><%out.println(contactData.getPhone()); %></td>
    <td><%out.println(contactData.getMsg()); %></td>
  </tr>
