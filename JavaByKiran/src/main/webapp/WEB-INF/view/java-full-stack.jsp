        ...
        <div class="col-md-6">
          <div class="detail-box">
            ...
            <h4>
              ...
              This Advance Java Industrial Training course is designed to provide in-depth knowledge and practical experience in Java programming for industrial applications. Participants will gain proficiency in advanced Java concepts and frameworks commonly used in the industry.
            <p>
            <h4>
              Key Highlights
            </h4>
             <li>Comprehensive training on advanced Java programming</li>
             <li>In-depth understanding of Java frameworks and industry best practices</li>
